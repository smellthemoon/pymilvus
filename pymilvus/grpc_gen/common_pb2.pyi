...
class MsgBase(_message.Message):
    __slots__ = ["msgID", "msg_type", "properties", "replicateInfo", "sourceID", "targetID", "timestamp"]
...
class NodeInfo(_message.Message):
    __slots__ = ["address", "hostname", "nodeID"]
...
class Status(_message.Message):
    __slots__ = ["code", "detail", "error_code", "reason", "retriable"]
