...
import rg_pb2 as _rg_pb2
import schema_pb2 as _schema_pb2
import feder_pb2 as _feder_pb2
import msg_pb2 as _msg_pb2
...
class AlterIndexRequest(_message.Message):
    __slots__ = ["base", "collection_name", "db_name", "extra_params", "index_name"]
    BASE_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
...
class CreateResourceGroupRequest(_message.Message):
    __slots__ = ["base", "config", "resource_group"]
    BASE_FIELD_NUMBER: _ClassVar[int]
...
class DeleteRequest(_message.Message):
    __slots__ = ["base", "collection_name", "consistency_level", "db_name", "expr", "hash_keys", "partition_name"]
    BASE_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    CONSISTENCY_LEVEL_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
...
class DescribeAliasResponse(_message.Message):
    __slots__ = ["alias", "collection", "db_name", "status"]
    ALIAS_FIELD_NUMBER: _ClassVar[int]
...
class DescribeCollectionResponse(_message.Message):
    __slots__ = ["aliases", "collectionID", "collection_name", "consistency_level", "created_timestamp", "created_utc_timestamp", "db_name", "num_partitions", "physical_channel_names", "properties", "schema", "shards_num", "start_positions", "status", "virtual_channel_names"]
...
class DescribeIndexRequest(_message.Message):
    __slots__ = ["base", "collection_name", "db_name", "field_name", "index_name", "timestamp"]
    BASE_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_NAME_FIELD_NUMBER: _ClassVar[int]
...
class FlushResponse(_message.Message):
    __slots__ = ["coll_flush_ts", "coll_seal_times", "coll_segIDs", "db_name", "flush_coll_segIDs", "status"]
...
class GetFlushAllStateRequest(_message.Message):
    __slots__ = ["base", "db_name", "flush_all_ts"]
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    FLUSH_ALL_TS_FIELD_NUMBER: _ClassVar[int]
    base: _common_pb2.MsgBase
...
class GetFlushStateRequest(_message.Message):
    __slots__ = ["collection_name", "db_name", "flush_ts", "segmentIDs"]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
...
class GetIndexStatisticsRequest(_message.Message):
    __slots__ = ["base", "collection_name", "db_name", "index_name", "timestamp"]
    BASE_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    INDEX_NAME_FIELD_NUMBER: _ClassVar[int]
...
class HybridSearchRequest(_message.Message):
    __slots__ = ["base", "collection_name", "consistency_level", "db_name", "guarantee_timestamp", "not_return_all_meta", "output_fields", "partition_names", "rank_params", "requests", "travel_timestamp", "use_default_consistency"]
    BASE_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    CONSISTENCY_LEVEL_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
...
class ImportRequest(_message.Message):
    __slots__ = ["channel_names", "clustering_info", "collection_name", "db_name", "files", "options", "partition_name", "row_based"]
...
class ListAliasesResponse(_message.Message):
    __slots__ = ["aliases", "collection_name", "db_name", "status"]
    ALIASES_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
...
class ListDatabasesResponse(_message.Message):
    __slots__ = ["created_timestamp", "db_names", "status"]
    CREATED_TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
...
class ManualCompactionRequest(_message.Message):
    __slots__ = ["collectionID", "majorCompaction", "timetravel"]
    COLLECTIONID_FIELD_NUMBER: _ClassVar[int]
...
class ManualCompactionResponse(_message.Message):
    __slots__ = ["compactionID", "compactionPlanCount", "status"]
    COMPACTIONID_FIELD_NUMBER: _ClassVar[int]
...
class RenameCollectionRequest(_message.Message):
    __slots__ = ["base", "db_name", "newDBName", "newName", "oldName"]
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
...
class ReplicateMessageRequest(_message.Message):
    __slots__ = ["BeginTs", "EndPositions", "EndTs", "Msgs", "StartPositions", "base", "channel_name"]
    BASE_FIELD_NUMBER: _ClassVar[int]
...
class ResourceGroup(_message.Message):
    __slots__ = ["capacity", "config", "name", "nodes", "num_available_node", "num_incoming_node", "num_loaded_replica", "num_outgoing_node"]
...
class SearchRequest(_message.Message):
    __slots__ = ["base", "collection_name", "consistency_level", "db_name", "dsl", "dsl_type", "guarantee_timestamp", "not_return_all_meta", "nq", "output_fields", "partition_names", "placeholder_group", "search_by_primary_keys", "search_params", "travel_timestamp", "use_default_consistency"]
    BASE_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    CONSISTENCY_LEVEL_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
